...
export const initWABubble = () => {
  ...
  // تم إصلاح الأيقونة هنا لتكون svg بدلاً من jpg
  btn.innerHTML = `
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="white" width="30" height="30">
...
export const initCountdownTimer = (targetEl, durationMinutes = 47) => {
  ...
  const key = "kawtharabdo_countdown_end";
...
export const initShareButton = (targetEl) => {
  ...
  // تم إصلاح الأيقونة هنا أيضاً
  const svgIcon = `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>`;
...
/* =========================================================================
   ...
   ========================================================================= */
const RV_KEY = "kawtharabdo_recently_viewed";
const MAX_RV = 6;
