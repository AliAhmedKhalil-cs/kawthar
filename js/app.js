...
const translations = {
  en: {
    ...
    stat_1: "Stainless Steel", stat_2: "Wear Life", stat_3: "Rust. Ever.",
    test_eyebrow: "Testimonials",
    test_title: "Worn & adored",
    review_1: '"The bracelet hasn\'t tarnished in 8 months. I wear it every day, even in the shower."',
    review_2: '"The packaging alone felt like a luxury gift. I bought it for myself and couldn\'t be happier."',
    review_3: '"Ordered via WhatsApp and received my necklace in perfect condition. KAWTHAR is my go-to."',
  ...
  ar: {
    ...
    material_2_desc: "البسيها في المطر أو المسبح أو طوال يومك.",
    ...
    craft_desc_1: "كل قطعة كوثر تولد من فلسفة الأناقة.",
    craft_desc_2: "نختار الستانلس ستيل لمتانته وقدرته على الحفاظ على لمعان ساطع.",
    stat_1: "ستانلس ستيل", stat_2: "عمر الارتداء", stat_3: "صدأ. أبداً.",
    test_eyebrow: "آراء العملاء",
    test_title: "مرتداة ومحبوبة",
    review_1: "السوار لم يتلون في 8 أشهر. أرتديه كل يوم.",
    review_2: "التغليف وحده كان يبدو هدية فاخرة.",
    review_3: "طلبت عبر واتساب واستلمت قلادتي في حالة مثالية.",
    review_verified: "مشترية موثقة",
...
const setLanguage = (lang) => {
  ...
  localStorage.setItem("kawtharabdo_lang", lang);
...
const initLanguage = () => {
  const savedLang = localStorage.getItem("kawtharabdo_lang") || "en";
...
const hideSplash = () => {
  ...
  if (splash) {
    if (!sessionStorage.getItem("kawtharabdo_splashed")) {
      setTimeout(() => {
        splash.style.transition = "opacity 0.4s ease";
        splash.style.opacity = "0";
        setTimeout(() => splash.classList.add("hidden"), 400);
        sessionStorage.setItem("kawtharabdo_splashed", "true");
...
const startApp = async () => {
  ...
  initLanguage();
  initGiftMode();
  window.addEventListener("kawtharabdo-products-updated", () => {
    try {
      initPriceFilter();
      rerender();
